    ...
    repository: [
      {
        ...
        owner: {
          ...
          subscriptions_url:
            "https://api.github.com/users/caamaann/subscriptions",
          organizations_url: "https://api.github.com/users/caamaann/orgs",
          repos_url: "https://api.github.com/users/caamaann/repos",
          events_url: "https://api.github.com/users/caamaann/events{/privacy}",
          received_events_url:
        ...
        blobs_url:
          "https://api.github.com/repos/caamaann/ableton/git/blobs{/sha}",
        git_tags_url:
          "https://api.github.com/repos/caamaann/ableton/git/tags{/sha}",
        git_refs_url:
          "https://api.github.com/repos/caamaann/ableton/git/refs{/sha}",
        trees_url:
          "https://api.github.com/repos/caamaann/ableton/git/trees{/sha}",
        statuses_url:
          "https://api.github.com/repos/caamaann/ableton/statuses/{sha}",
        languages_url:
          "https://api.github.com/repos/caamaann/ableton/languages",
        stargazers_url:
          "https://api.github.com/repos/caamaann/ableton/stargazers",
        contributors_url:
        ...
        commits_url:
          "https://api.github.com/repos/caamaann/ableton/commits{/sha}",
        git_commits_url:
        ...
        downloads_url:
          "https://api.github.com/repos/caamaann/ableton/downloads",
        issues_url:
          "https://api.github.com/repos/caamaann/ableton/issues{/number}",
        pulls_url:
          "https://api.github.com/repos/caamaann/ableton/pulls{/number}",
        milestones_url:
        ...
        labels_url:
          "https://api.github.com/repos/caamaann/ableton/labels{/name}",
        releases_url:
          "https://api.github.com/repos/caamaann/ableton/releases{/id}",
        deployments_url:
...
describe("SearchList Component", () => {
  it("renders loading skeletons when isLoading is true", () => {
    render(<SearchList isLoading={true} data={[]} q="a" />);
  ...
  it("renders user list when isLoading is false and data is provided", () => {
    render(<SearchList isLoading={false} data={mockUsers} q="" />);
