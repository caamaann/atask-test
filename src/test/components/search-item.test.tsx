...
const mockUserWithRepositories = {
  login: "caamaann",
  id: 36650325,
  ...
  following_url: "https://api.github.com/users/caamaann/following{/other_user}",
  ...
  received_events_url: "https://api.github.com/users/caamaann/received_events",
  type: "User",
...
describe("SearchItem Component", () => {
  it("renders user with repositories correctly", () => {
    render(
      <Accordion type="single">
        <SearchItem data={mockUserWithRepositories} />
      </Accordion>
    );

    const accordionItem = screen.getByTestId("search-item");
